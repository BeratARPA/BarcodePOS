...
namespace WindowsFormsAppUI.Helpers
{
    public class NavigationManager
    {
        public static void OpenForm(Form form, DockStyle dockStyle, Panel parentPanel)
        {
            ...
            {
                if (formCollection[i].Name != "ShellForm" && formCollection[i].Name != "DashboardForm" && formCollection[i].Name != "PersonalizationForm"&& !formCollection[i].Name.Contains("CustomerCallingForm"))
                {
